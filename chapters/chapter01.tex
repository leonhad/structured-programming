...
\quad begin SET QUEEN ON SQUARE$[1, h_1]$;
...
\textbf{if} SQUARE$[0,h]$ FREE \textbf{do}
...
INITIALISE EMPTY BOARD; $n \coloneq 0$;
...
\textbf{boolean array} up$[-7:+7]$, down$[0:14]$
