...
\section[On the reliability of mechanisms]{On The Reliability Of Mechanisms}
...
\section[An example of a correctness proof]{An Example Of A Correctness Proof}
...
\begin{enumerate}[wide, nosep, label=\textit{Remark }\arabic*.]
	\item The program
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=.7\textwidth]{chap1/fig2}
\end{figure}

\begin{figure}[ht!]
	\centering
	\includegraphics[width=.8\textwidth]{chap1/fig3}
\end{figure}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\textwidth]{chap1/fig4}
\end{figure}
...
\noindent
description 0:
\labeltext{description 0}{tx:description-0}
...
\labeltext{description 1}{tx:description-1}
...
\noindent
description 2:
\labeltext{description 2}{tx:description-2}
\nopagebreak
...
\noindent
but we shall not do this as the sequencing in the two versions differs (see ``\nameref{sec:comparing-programs}'') and we regard them as ``incomparable''. By choosing 2b1(3) we decide that our trial 2b1(2) \textemdash{}  as 2b1(1) \textemdash{}  is no longer applicable and therefore rejected.
...
\section[On trading storage space for computation speed]{On Trading Storage Space For Computation Speed}
...
\section[On a program model]{On A Program Model}
...
\begin{enumerate}[wide, nosep, label=(\arabic*)]
	\item Our experience as recorded in ``\nameref{sec:first-example-step-wise-program-composition}'' strongly suggests that the arrangement of various layers, corresponding to different levels of abstraction, is an attractive vehicle for program composition.
...
\section[A second example of step-wise program composition]{A Second Example Of Step-Wise Program Composition}
...
\quad \quad print trial sequence
...
Generating all elements of set $B$ \textemdash{}  for the moment we forget about the printing of those: configurations that belong to set $A$ as well \textemdash{}  then presents itself as
