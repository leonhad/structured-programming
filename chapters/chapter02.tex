...
\quad \textbf{if} sessioncount (bestsofar) $<$ sessioncount $($trial$)$ \textbf{then}

\quad \quad bestsofar $\coloneq$ trial.
...
\quad \textbf{begin} trial, bestsofar:session; $e$:exam; untried:\textbf{powerset} exam;

\quad \quad $e$ \textbf{from} remaining;

\quad \quad trial $\coloneq$ bestsofar $\coloneq$ $\{e\}$;

\quad \quad untried $\coloneq$ remaining $-$ trial $-$ incompat$(e)$;
...
(10)\tabto*{3.5em} $k_1 = T$.min

\tabto*{2.5em}\& $k_2 = \text{succ}(k_1)$

\tabto*{2.5em}\& $k_3 = \text{succ}(k_2)$

\tabto*{3.5em}\dots

\tabto*{2.5em}\& $k_n = \text{succ}(k_{n-1}) = T$.max.
...
\begin{enumerate}[leftmargin=2.4\parindent, label=(\arabic*)]
	\setcounter{enumi}{10}
	\item $T(T_0(x)) = x$.
...
\begin{enumerate}[leftmargin=2.4\parindent, label=(T\arabic*)]
	\item $x \leqslant x$.
...
\begin{enumerate}[leftmargin=2.4\parindent, label=(\arabic*)]
	...
	\item $x \oplus y$ \tabto*{3.2em},, \tabto*{5.4em},, \tabto*{7.4em}$T_0(x) \oplus T_0(y)$.
	
	\item $x \oplus a$ \tabto*{3.2em},, \tabto*{5.4em},, \tabto*{7.4em}$T_0(x) \oplus a.$

	\item $a \oplus x$ \tabto*{3.2em},, \tabto*{5.4em},, \tabto*{7.4em}$a \oplus T_0(x).$

	\item $a \coloneq x$ \tabto*{3.2em},, \tabto*{5.4em},, \tabto*{7.4em} $a\coloneq T_0(x)$.
\end{enumerate}
